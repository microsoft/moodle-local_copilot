 ...
 */
class local_resource_base_course_test extends base_test {
     ...
     */
    public function test_extract_course_data() {
     ...
     */
    public function test_get_return_structure() {
     ...
     * @covers \local_copilot\local\resource\base_course::extract_course_data
     */
    public function test_extract_course_data_with_image() {
        global $CFG;
     ...
     * @covers \local_copilot\local\resource\base_course::extract_course_data
     */
    public function test_extract_course_data_with_completion() {
        global $CFG, $DB;
     ...
     * @covers \local_copilot\local\resource\base_course::extract_course_data
     */
    public function test_extract_course_data_with_dates() {
        global $DB;
     ...
     * @covers \local_copilot\local\resource\base_course::extract_course_data
     */
    public function test_extract_course_data_with_format() {
        $coursedata = base_course::extract_course_data($this->course, $this->student->id);
     ...
     * @covers \local_copilot\local\resource\base_course::extract_course_data
     */
    public function test_extract_course_data_with_category() {
     ...
     * @covers \local_copilot\local\resource\base_course::extract_course_data
     */
    public function test_extract_course_data_invalid_user() {
     ...
     * @covers \local_copilot\local\resource\base_course::extract_course_data
     */
    public function test_extract_course_data_visibility() {
        global $DB;
     ...
     * @covers \local_copilot\local\resource\base_course::extract_course_data
     */
    public function test_extract_course_data_with_language() {
        global $DB;
     ...
     * @covers \local_copilot\local\resource\base_course::get_return_structure
     */
    public function test_return_structure_completeness() {
        $structure = base_course::get_return_structure();
