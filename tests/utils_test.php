...
class utils_test extends \advanced_testcase {
     ...
     */
    public function test_is_guid_valid($guid, $requirehyphens, $expected) {
     ...
     * @return array
     */
    public function valid_guid_provider(): array {
        return [
     ...
     * @covers \local_copilot\utils::is_guid
     */
    public function test_is_guid_invalid_types() {
     ...
     */
    public function test_is_sharepoint_onedrive_url($url, $expectedvalid, $expectedtype) {
     ...
     * @return array
     */
    public function sharepoint_onedrive_url_provider(): array {
        return [
     ...
     */
    public function test_is_onedrive_url($host, $path, $expected) {
     ...
     * @return array
     */
    public function onedrive_url_provider(): array {
        return [
     ...
     */
    public function test_is_sharepoint_url($host, $path, $expected) {
     ...
     * @return array
     */
    public function sharepoint_url_provider(): array {
        return [
     ...
     */
    public function test_is_basic_configuration_complete() {
        global $CFG, $DB;
        $this->resetAfterTest();
     ...
     */
    public function test_is_agent_configured() {
        $this->resetAfterTest();
     ...
     */
    public function test_get_oauth_client_options() {
        global $DB;
        $this->resetAfterTest();
     ...
     */
    public function test_get_agent_configuration_form_data() {
        $this->resetAfterTest();
     ...
     * @covers \local_copilot\utils::get_agent_configuration_form_data
     */
    public function test_get_agent_configuration_form_data_invalid_role() {
        $this->resetAfterTest();
